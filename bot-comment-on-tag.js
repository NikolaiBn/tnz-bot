...
// WHITELIST
      ...
      var whitelist = ['kiwioz','ravenruis','cryptonik','questingtw','devitech','zephyr119','imjustsaying','conradt','schopenhauer','jackmiller','trudeehunter','thetinykitchen','andysantics48','len.george','kiwiscanfly','john-unasa','melissakellie','biglipsmama','sift666','betelzeus','youvegotquail','kiwideb','samueldouglas','choogirl','ausbitbank','forkyw','masterswatch','uniforce','gamersclassified'];
//START
